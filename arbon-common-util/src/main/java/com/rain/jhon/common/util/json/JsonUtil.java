package com.rain.jhon.common.util.json;
...
public class JsonUtil {
    ...
    /**
     * <p> 功能描述：对于有多层的对象的转换</p>
     * @author  jiangyu
     * @date  2017年2月23日 上午11:39:56
     * @param jsonStr
     * @param clazz
     * @return
     * @version v1.0
    ...
    public static HashMap<String, Object> jsonToMap(Object jsonObj){  
        ...
        for(Object k : json.keySet()){  
            ...
            if(v instanceof JSONArray){  
                ...
                if (!CollectionUtil.isEmpty(list)&&list.contains(null))
                {
                    List<Map<String,Object>> nullCollectionList  = new ArrayList<Map<String,Object>>();
                    nullCollectionList.add(null);
    ...
    /**
     * <p> 功能描述：移除json中相应的节点 </p>
     * @author  jiangyu
     * @date  2016年7月23日 下午2:08:25
     * @param jsonStr
     * @return
     */
    public static String removeJsonNode(String jsonStr,String key)
    {
        ...
        {
            Map<String, Object> tempMap = JsonUtil.jsonToMap(jsonStr);
            if (tempMap.containsKey(key))
            {
                tempMap.remove(key);
            }
            return JsonUtil.objectToJson(tempMap);
        }
        return null;
    }
}
